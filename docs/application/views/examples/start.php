...
<div class="wrapper">
	...
	<div class="examples">
		<a href="<?=site_url('example/web_login') ?>" class="web">Redirect Login<br/>Example</a>
		<a href="<?=site_url('example/js_login') ?>" class="js">Javascript Login<br/>Example</a>
	</div>
...
// $loginUrl = $helper->getLoginUrl(base_url().'Example/fb_callback', $permissions);
